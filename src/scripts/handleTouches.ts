...
export default function handleTouches() {
	//* Create Page Palette
	;(document.querySelector('#palette')! as HTMLElement).ontouchend = async (e) => {
		let target = e.targetTouches[0].target as HTMLElement
	...
	;(document.querySelector('.palettes-page .saved-palettes-wrapper') as HTMLElement)!.ontouchend = async (e) => {
		let target = e.targetTouches[0].target as HTMLElement
	...
	//* Toolbar
	;(document.querySelector('.toolbar') as HTMLElement)!.ontouchend = async (e) => {
		let target = e.targetTouches[0].target as HTMLElement
